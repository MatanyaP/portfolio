          ...
          <main className="flex-1">
            <div className="mt-12 mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
              <h2 className="text-4xl font-extrabold leading-10 tracking-tight text-gray-900 sm:text-5xl sm:leading-none md:text-6xl">
                <span className="text-lime-500">Hi, I'm Matan</span>
                <span className="text-lime-300">Peretz</span>
              </h2>
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                You can learn more about me using the <a class="underline decoration-lime-500">terminal</a> below
                <br />
                or navigate using the <a class="underline decoration-lime-300">menu</a>, like my aunt Alice.
              </p>
            </div>
